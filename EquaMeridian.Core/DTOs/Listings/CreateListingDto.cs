...
namespace EquaMeridian.DTOs.Listings
{
    public class CreateListingDto : IValidatableObject
    {
        ...
        /// <summary>Manufacture year. Must be between 1950 and next calendar year when provided.</summary>
        ...
        [Required(ErrorMessage = "You must accept the Master Lease Agreement to list this machinery.")]
        public bool AgreeToMasterLeaseAgreement { get; set; } = false;
